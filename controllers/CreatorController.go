...
// 	articleLists := []models.Article_bases{}
// 	utils.DB.Where("class_id=?", 7).Order("id desc").Find(&articleLists)
...
// 	article_lists := []models.Article_bases{}
// 	utils.DB.Where("class_id=? AND is_temp=?", 13, true).Order("id desc").Find(&article_lists)
