...
func (c *MainController) Get() {
	...
	article_lists = []models.Article_bases{}
	utils.DB.Order("id desc").Offset((pageindex - 1) * pagesize).Limit(pagesize).Find(&article_lists)
...
//视频播放器路由
func (c *MainController) VideoPlayer() {
	c.TplName = "pages/video/index.tpl"
}

//Pdf阅读器路由
func (c *MainController) PdfReader() {
	c.TplName = "pages/reader/index.tpl"
}
