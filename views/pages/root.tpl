{{/*PC端页面*/}}
    <div class="uk-container uk-container-xlarge main_page">
        <div class="uk-flex uk-flex-center uk-visible@m uk-margin-medium-top content">
            <div class="uk-width-2-3 main_pc_div">
                {{/*图片轮播*/}}
                <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slideshow="finite: false;ratio: 2:1;animation: scale" autoplay-interval=3000 autoplay="true" pause-on-hover="true" style="display:block;padding: 20px">
                ...
                <div class="uk-margin-medium-top">
                    ...
                    <div class="uk-margin-large-top">
                        <ul class="uk-pagination uk-flex-center" uk-margin>
                            {{$pgindex := .pageindex}}
                            <li><a href="/?pageIndex={{.prepage}}"><span uk-pagination-previous></span></a></li>
                            {{if gt .pagecount 7}} 
                                {{range $i, $v := .pagetop_arr}}
                                    {{if eq $v $pgindex}}
                                        <li class="uk-active" style="font-size: 17px"><a href="/?pageIndex={{$v}}">{{$v}}</a></li>
                                    {{else}}
                                        <li class=""><a href="/?pageIndex={{$v}}">{{$v}}</a></li>
                                    {{end}}
                                {{end}}
                            ...
                            <li><a href="/?pageIndex={{.nexpage}}"><span uk-pagination-next></span></a></li>
                        </ul>
                    </div>
            ...
            <!-- 侧边栏 -->
            <!-- <div class="uk-width-1-5 uk-visible@m uk-margin-small-left">
                ...
                <div class="uk-card uk-card-default uk-card-body uk-margin-small-top uk-text-center show_card">
                 ...
                 <div class="uk-card uk-card-default uk-card-body uk-margin-small-top uk-height-medium uk-text-center show_card">
                    ...
                    <hr>
                    <span class="uk-text-large uk-text-bold">1. 让技术给生活添加乐趣</span><br>
                    <span class="uk-text-large uk-text-bold">2. 让技术给别人带来价值</span><br>
                    <span class="uk-text-large uk-text-bold">3. 让技术实现自我价值</span><br>
                </div>
